...
namespace safe
{
	...
	private:
		...
		public:
			...
			EXPLICIT_IF_CPP17
			Access(ReferenceType value, MutexType &mutex, OtherLockArgs &&...otherLockArgs) : lock(mutex, std::forward<OtherLockArgs>(otherLockArgs)...),
																							  m_value(value)
			{
			}
			...
			template <typename... OtherLockArgs>
			EXPLICIT_IF_CPP17
			Access(const Safe &safe, OtherLockArgs &&...otherLockArgs) : Access(safe.m_value, safe.m_mutex.get, std::forward<OtherLockArgs>(otherLockArgs)...)
			{
			}
			...
			template <typename... OtherLockArgs>
			EXPLICIT_IF_CPP17
			Access(Safe &safe, OtherLockArgs &&...otherLockArgs) : Access(safe.m_value, safe.m_mutex.get, std::forward<OtherLockArgs>(otherLockArgs)...)
			{
			}
			...
			EXPLICIT_IF_CPP17
			Access(Access<OtherLockType, OtherMode> &otherAccess, OtherLockArgs &&...otherLockArgs) : Access(*otherAccess, *otherAccess.lock.release(), std::adopt_lock, std::forward<OtherLockArgs>(otherLockArgs)...)
			{
	...
	public:
		...
		explicit Safe(DefaultConstructMutex, ValueArgs &&...valueArgs) : m_mutex(),
		...
		explicit Safe(MutexArg &&mutexArg, ValueArgs &&...valueArgs) : m_mutex{std::forward<MutexArg>(mutexArg)},
																	   m_value(std::forward<ValueArgs>(valueArgs)...)
		{
		}
